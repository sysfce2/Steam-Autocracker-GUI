        ...
        private async Task<string> UploadToBackend(string filePath, Form parentForm)
        {
            try
            {
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Add("Authorization", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNzMwNjU4OTAyfQ.GE5pKRsUvUUdXb49B5M4VF74Z8b_SFD7WTRqNrKFuvc");
                    ...
                    using (var content = new MultipartFormDataContent())
                    {
                        ...
                        using (var fileStream = new FileStream(filePath, FileMode.Open, FileAccess.Read))
                        {
                            ...
                            {
                                progressClient.DefaultRequestHeaders.Add("Authorization", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNzMwNjU4OTAyfQ.GE5pKRsUvUUdXb49B5M4VF74Z8b_SFD7WTRqNrKFuvc");
